-- ============================================================
-- BlueBush Cloudflare D1 Migration: Initial Schema & Seed Data
-- ============================================================
...
('What is BlueBush?', 'BlueBush is a Perth-based online retailer of premium sustainable homewares. We stock ethically sourced, beautifully crafted essentials for every room in your home—from OEKO-TEX certified linen sheets to FSC-certified timber serving boards.', '["brand","about"]'),
('What makes BlueBush sustainable?', 'We carefully select products that are certified organic, biodegradable, compostable, made from recycled materials, or manufactured under ethical labour conditions. Many products carry third-party certifications like OEKO-TEX, GOTS, FSC, and Compostable logos.', '["sustainability","brand"]'),
('Do you sell gift cards?', 'Yes, digital gift cards are available in amounts from $25 to $250. Contact us at hello@bluebush.com.au to purchase a gift card for a loved one.', '["gifts","products"]'),
('Is BlueBush an Australian company?', 'Yes! BlueBush is proudly Australian, based in Forrestfield, Western Australia. While some of our products are manufactured overseas under ethical conditions, we are a 100% Australian-owned and operated business.', '["brand","australia"]')
ON CONFLICT DO NOTHING;
